                    ...
                    return (
                        <tr key={model.id} className={`row-${model.id}`}>
                            ...
                            <td className="action">
                                ...
                                <a className="tooltip" href="javascript:void(0);" onClick={() => props.showConfirmBox( model.id)} data-tooltip="Delete"><i className="material-icons">delete</i></a>
                                {props.confirmText == model.id ? (
                                    <span className="confirm tooltip-text">Are you sure?&nbsp;
                                        <a onClick={props.deleteModel.bind(null, model.id)} href="javascript:void(0);">Yes</a> &nbsp;
                                        <a href="javascript:void(0);" onClick={props.hideConfirmText.bind(null)}>No</a>
                                    </span>
                                ) : null}
                            </td>
                            <td>
