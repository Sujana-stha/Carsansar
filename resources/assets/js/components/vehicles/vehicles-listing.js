            ...
            {props.vehicles.map((vehicle, index) => {
                return (
                    <tr key={vehicle.id}>
                        ...
                        <td className="action">
                            <Link to={'/edit-vehicle'} onClick={() => props.onEdit(vehicle.id)} className="tooltipped" data-position="top" data-delay="50" data-tooltip="Edit"><i className="material-icons">edit</i></Link>
